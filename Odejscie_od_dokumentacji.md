...
## Rules
Modół potrzebuję połączenia z modułem `Board`, bo używa struktury `CellState`. Funkcja `nextState` nie musi zwracać tablicy stanów komórek, wystarczy stan aktualnie rozpratywanej komórki.
