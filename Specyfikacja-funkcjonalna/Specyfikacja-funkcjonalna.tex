...
Program prowadzi dialog z użytkownikiem pozwalając na wybór wszystkich niezbędnych ustawień. Prosi użytkownika o podawanie kolejnych parametrów zgonie z którymi program będzie działać, na bieżąco kontrolując ich poprawność, nie dopuszczając danych mogących negatywnie wpłynąć na działanie programu.
